...
// defaults matching the new grocery signup design shown in the screenshot
const DEFAULT_SECTIONS: FormValues["sections"] = [
  {
    id: "section-business-type",
  ...
  {
    id: "section-phone-number",
    title: "Your Phone Number",
    fields: [
      { id: "continue-shop-owner", label: "Continue as Shop Owner" },
      { id: "continue-shop-manager", label: "Continue as Shop Manager" },
    ],
  },
  {
    id: "section-signup-for-merchants",
    title: "Sign up for Name for Merchants to...",
    fields: [
  ...
  {
    id: "section-signup-unlock-sales",
    title: "Sign up for Name and Unlock Sales",
    fields: [
      { id: "store-name", label: "Store Name" },
      { id: "store-address", label: "Store Address" },
      { id: "email-address-store", label: "Email Address" },
      { id: "country-store", label: "Country" },
      { id: "store-number", label: "Store Number" },
    ],
  },
  {
    id: "section-kyc",
  ...
  {
    id: "section-upload-documents",
    title: "Upload Documents",
    fields: [
      { id: "business-licence-number", label: "Business Licence Number" },
      { id: "ein-number", label: "EIN Number" },
      { id: "driving-licence", label: "Driving Licence" },
    ],
  },
  {
    id: "section-store-details",
    title: "Store Details",
    fields: [
      { id: "store-name-detail", label: "Store Name" },
      { id: "store-logo", label: "Store Logo" },
      { id: "store-description", label: "Store Description" },
    ],
  },
  {
    id: "section-order-method",
    title: "Order Method",
    fields: [
