...
import GroceryEditSideTabDialog from "./GroceryEditSideTabDialog";
import grocerySideNavigationMockup from "@/assets/app-manage/grocery-app/grocery-app-side-nav.png";
import grocerySideNavigationHiddenMockup from "@/assets/app-manage/grocery-app/grocery-app-side-nav-hidden.png";
...
interface GrocerySideNavigationDialogProps {
  open: boolean;
...
const defaultTabs: NavigationTab[] = [
  ...
  { id: "ratings-reviews", label: "Ratings & Reviews", visible: true },
...
export default function GrocerySideNavigationDialog({
  open,
  setOpen,
  onApply,
  onCancel,
}: GrocerySideNavigationDialogProps) {
          ...
          <div className="relative flex">
            ...
            <div className="absolute -right-65 top-1/2 transform -translate-y-1/2 flex items-center justify-center">
              <img
                src={
                  anyHidden
                    ? grocerySideNavigationHiddenMockup
                    : grocerySideNavigationMockup
                }
                alt="Grocery Side Navigation Preview"
