...
import GroceryBottomNavigationDialog from "@/components/app-manage/GroceryBottomNavigationDialog";
import GrocerySideNavigationDialog from "@/components/app-manage/GrocerySideNavigationDialog";
...
export default function GroceryAppTab() {
  // App Color
  ...
  }; // there are no other changes required for handler, dialog works identically

  // Side navigation
  const [isSideNavDialogOpen, setIsSideNavDialogOpen] = useState(false);
  const [sideNavCount, setSideNavCount] = useState<number>(8);
