...
import BottomNavigationDialog from "@/components/app-manage/BottomNavigationDialog";
import SideNavigationDialog from "@/components/app-manage/SideNavigationDialog";
...
import SignUpScreenDialog from "@/components/app-manage/SignUpScreenDialog";
...
export default function UserAppTab() {
  ...
  const cards = [
    ...
    },
    {
      ...
      subtitle: `${signUpConfig.fields.length} Field${
        signUpConfig.fields.length > 1 ? "s" : ""
      } needed`,
