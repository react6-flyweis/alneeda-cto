...
import sideNavigationMockup from "@/assets/app-manage/side-navigation.png";
import EditSideTabDialog from "./EditSideTabDialog";
...
const defaultTabs: NavigationTab[] = [
  { id: "order-history", label: "Order History", visible: true },
  { id: "payment-methods", label: "Payment Methods", visible: true },
  { id: "food-truck-bookings", label: "My Food Truck Bookings", visible: true },
  { id: "saved-addresses", label: "Saved Addresses", visible: true },
  { id: "offers-coupons", label: "Offers & Coupons", visible: true },
  { id: "favorites", label: "My Favorites", visible: true },
  { id: "invite-refer", label: "Invite & Refer", visible: true },
...
export default function SideNavigationDialog({
  open,
  setOpen,
  onApply,
  onCancel,
  ...
  return (
    <>
        ...
        <DialogContent className="sm:max-w-sm p-0 gap-0">
          <div className="relative flex">
            ...
            <div className="absolute -right-65 top-1/2 transform -translate-y-1/2 flex items-center justify-center">
              <img
                src={sideNavigationMockup}
                alt="Side Navigation Preview"
      ...
      {/* Edit Tab / Change Title Dialog (side-nav specific) */}
      <EditSideTabDialog
        open={editDialogOpen}
