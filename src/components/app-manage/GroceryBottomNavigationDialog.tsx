...
import GroceryEditTabDialog from "./GroceryEditTabDialog";
import groceryBottomNavigationMockup from "@/assets/app-manage/grocery-app/grocery-app-bottom-nav.png";
import groceryBottomNavigationHiddenMockup from "@/assets/app-manage/grocery-app/grocery-app-bottom-nav-hidden.png";
...
interface GroceryBottomNavigationDialogProps {
  open: boolean;
...
// default tabs tailored for the grocery app
...
export default function GroceryBottomNavigationDialog({
  open,
  setOpen,
  onApply,
  onCancel,
}: GroceryBottomNavigationDialogProps) {
              ...
              <img
                src={
                  tabs.find((t) => t.id === "profile" && t.visible)
                    ? groceryBottomNavigationMockup
                    : groceryBottomNavigationHiddenMockup
                }
